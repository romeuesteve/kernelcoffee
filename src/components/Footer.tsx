...
const footerLinks = {
  ...
  support: [
    { label: 'FAQ', href: '#faq' },
    { label: 'Contact', href: 'mailto:hello@kernelcoffee.com' },
    { label: 'Shipping', href: '#' },
  ],
};
...
export function Footer() {
  return (
    <footer className="border-t border-border py-16 bg-secondary/5">
      <div className="container mx-auto px-8">
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8 mb-12">
          ...
          <div className="col-span-2 space-y-4">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-lg">Kernel Coffee</span>
            </div>
            <p className="text-sm text-muted-foreground">
              Fuel for Deep Work. Coffee engineered for cognitive performance.
            </p>
            ...
            <code className="text-xs font-mono px-3 py-1 rounded bg-secondary text-secondary-foreground">
              echo "Happy Brewing!"
            </code>
          </div>
        ...
        <div className="border-t border-border pt-8 mb-8">
          <div className="max-w-md mx-auto text-center space-y-4">
            <h4 className="font-semibold">Get Weekly Productivity Tips</h4>
            <p className="text-sm text-muted-foreground">
        ...
        <div className="border-t border-border pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-muted-foreground">
          <p>&copy; 2024 Kernel Coffee. All rights reserved.</p>
